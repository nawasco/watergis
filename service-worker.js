const s = /* @__PURE__ */ location.pathname.split("/").slice(0, -1).join("/"), r = [
  s + "/_app/immutable/entry/app.fd438aaa.js",
  s + "/_app/immutable/nodes/0.431c0a10.js",
  s + "/_app/immutable/nodes/1.d84a4b92.js",
  ...
  s + "/_app/immutable/chunks/singletons.115a8a35.js",
  s + "/_app/immutable/entry/start.7d0a6e46.js",
  ...
  s + "/robots.txt"
], o = "1690719631005", n = self, p = `cache${o}`, h = r.concat(m), u = new Set(h);
